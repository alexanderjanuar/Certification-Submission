...
def solution_B4():
    ...
    training_labels, validation_labels = train_test_split(labels, train_size=training_portion,
    ...
    training_padded = keras.preprocessing.sequence.pad_sequences(training_sequences, maxlen=max_length, padding=padding_type, truncating=trunc_type)

    validation_sequences = tokenizer.texts_to_sequences(validation_sentences)
    validation_padded = keras.preprocessing.sequence.pad_sequences(validation_sequences, maxlen=max_length, padding=padding_type,
